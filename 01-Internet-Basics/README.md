...
Welcome to Internet Basics! This module covers the fundamental concepts of how data travels across the internet.
...
- Learn about network layers (simplified OSI model)
...
1. **Application Layer**: Email client creates the message
2. **Transport Layer**: Breaks message into segments, adds port numbers
3. **Network Layer**: Adds IP addresses to create packets
4. **Link Layer**: Adds MAC addresses for local delivery, creates frames
5. **Physical Layer**: Converts to electrical signals on the wire
...
✅ **Network layers** organize networking functions into manageable components  
...
Now that you understand internet basics, you're ready to learn about **How The Web Works** - specifically about clients, servers, URLs, and how browsers work!

---

[← Back: Prerequisites](../00-Prerequisites/) | [Next: How The Web Works →](../02-How-The-Web-Works/)
