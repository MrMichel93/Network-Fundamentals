...
Visual representations to help understand RESTful API design and consumption.

## 1. Overview Diagram

Conceptual overview of RESTful API design and consumption:
...
How data flows in RESTful API design and consumption:
...
Typical patterns in RESTful API design and consumption:
...
Different approaches to RESTful API design and consumption:
